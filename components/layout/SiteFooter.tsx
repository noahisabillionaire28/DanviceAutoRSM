        ...
        <div className="grid gap-12 md:grid-cols-12 md:gap-8">
          <div className="md:col-span-4">
            ...
            <a
              ...
              className="tnum mt-6 inline-block font-display text-2xl text-cream-50 transition-colors hover:text-brand-400"
            >
              {SITE.phone.display}
            </a>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <a
              ...
              className="mt-3 inline-block text-sm text-cream-50/75 underline decoration-cream-50/25 underline-offset-4 transition-colors hover:text-cream-50 hover:decoration-brand-400"
            >
              Get directions
            </a>
          </div>
