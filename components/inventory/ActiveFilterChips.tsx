    ...
    >
      ...
      {chips.map((chip) => (
        <button
          ...
          className="inline-flex h-9 items-center gap-2 rounded-full border border-maroon-200 bg-surface px-3.5 text-sm text-maroon-900 transition-colors hover:border-maroon-300 hover:bg-cream-100"
        >
          {chip.text}
      ...
      <button
        ...
        className="inline-flex h-9 items-center rounded-full px-3 text-sm font-medium text-brand-600 underline decoration-brand-600/30 underline-offset-4 transition-colors hover:decoration-brand-600"
      >
        Clear all
      </button>
    </div>
