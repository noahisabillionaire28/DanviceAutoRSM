...
export function PaymentCalculator({
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 space-y-5">
        <div>
          <div className="flex items-center justify-between">
            <label htmlFor="down" className="text-sm font-medium text-blue-800">
              Down payment
            </label>
            <span className="tnum text-sm text-blue-900">{formatPrice(down)}</span>
          </div>
          <input
            id="down"
            type="range"
        ...
        <div>
          <div className="flex items-center justify-between">
            <label htmlFor="apr" className="text-sm font-medium text-blue-800">
              Estimated APR
            </label>
            <span className="tnum text-sm text-blue-900">{apr.toFixed(1)}%</span>
          </div>
          <input
            id="apr"
            type="range"
      ...
      <dl className="mt-6 space-y-2 border-t border-blue-100 pt-5 text-sm">
        <div className="flex justify-between">
          <dt className="text-muted">Amount financed</dt>
          <dd className="tnum text-blue-900">{formatPrice(estimate.amountFinanced)}</dd>
        </div>
        <div className="flex justify-between">
          <dt className="text-muted">Total interest</dt>
          <dd className="tnum text-blue-900">{formatPrice(estimate.totalInterest)}</dd>
        </div>
      </dl>
